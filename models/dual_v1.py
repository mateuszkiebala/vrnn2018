...
def half_model():
    ...
    model = Conv2D(64, (3, 3), activation='softmax', kernel_initializer=keras.initializers.RandomUniform(minval=-0.00005, maxval=0.00005, seed=None))(model)
    model = BatchNormalization(axis=3)(model)
    model = Activation('softmax')(model)
    model = MaxPooling2D((3, 3))(model)
    model = Conv2D(128, (3, 3), activation='softmax')(model)
    model = MaxPooling2D((3, 3))(model)
    model = Conv2D(256, (3, 3), activation='softmax')(model)
    model = BatchNormalization(axis=3)(model)
    model = Activation('softmax')(model)
    model = MaxPooling2D((3, 3))(model)
    model = Conv2D(512, (3, 3), activation='softmax', kernel_initializer=keras.initializers.RandomUniform(minval=-0.00005, maxval=0.00005, seed=None))(model)
    model = MaxPooling2D((3, 3))(model)
...
merged_model = Dense(512, activation='softmax')(merged_model)
merged_model = Dropout(.25)(merged_model)
merged_model = Dense(256, activation='softmax')(merged_model)
merged_model = Dropout(.25)(merged_model)
merged_model = Dense(128, activation='softmax')(merged_model)
merged_model = Dropout(.25)(merged_model)
merged_model = Dense(64, activation='softmax')(merged_model)
merged_model = Dropout(.25)(merged_model)
